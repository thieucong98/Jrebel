...
public class MainServer extends AbstractHandler {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("JRebel 2018.1 and later version Activation address was: http://localhost:" + port + "/{guid}(eg:http://localhost:" + port + "/"+ TOKEN +"), with any email.");
    ...
    private void indexHandler(String target, Request baseRequest, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        html += "<p>JRebel 2018.1 and later version Activation address was: http://localhost:" + port + "/{guid}(eg:<span style='color:red'>http://localhost:" + port + "/"+ TOKEN +"</span>), with any email.";
